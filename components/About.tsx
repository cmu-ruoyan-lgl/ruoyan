    ...
    >
      ...
      {activeLocale === "zh" || activeLocale === "cn" ? (
        ...
        <div className="flex flex-col gap-2">
          ...
          <div>
            2024年，遇到了骚哥（CL），骚哥入圈很久了，和我一样是对去中心化有信仰的人，正好也是我梦想大学cmu毕业的学长，我们相谈甚欢。当时闲聊得知他正在做一个基于AI的量化策略工作流，是一个可以让不懂代码的小白也可以生成交易策略的连线式的策略生成工具，我确信这是一个很有前景的项目，所以便加入兼职做开发工作，目前还在开发阶段，不过已经在不少黑客松获得了很高的评价和奖项了。
          </div>
          <div>
